    ...
    return (
        <div className='w-full flex flex-col items-center gap-7 p-6'>
            ...
            <div className='w-[70%] flex flex-col rounded-md p-6 bg-slate-50 items-center'>
                ...
                <p className='text-slate-800 w-[70%] text-center'>If you'de like to sell high-quality digital products you can do so in minutes <span className='font-semibold'>Get started</span></p>
            </div>
